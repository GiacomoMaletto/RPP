...
\textcolor{blue}{We formally show in \LEAN that the class of functions we can express as (algorithms) in \lstinline|rpp| contains at least the class \PRF of Primitive Recursive Functions; we say that ``\lstinline|rpp| is \PRF-sound''.}
...
\subsection{The extended definition of \texttt{primrec} in \MATHLIB}
