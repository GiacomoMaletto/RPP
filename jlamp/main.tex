...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        The pattern is obtained through the iteration of \lstinline|step (_)|, and becomes a reversible element in \lstinline|rpp| once fixed the parameter \lstinline|(_)| it depends on. Slightly different parameter instances generate reversible algorithms whose behavior we can certify in \LEAN. They are truncated Square Root, Quotient/Reminder of integer division, and Cantor Pairing \cite{Cantor1878,DBLP:journals/corr/Szudzik17}.
