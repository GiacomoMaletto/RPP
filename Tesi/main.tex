...
then the function obtained by \textbf{primitive recursion} $H=\prPrec[F,G]:\NN^{n+1} \to \NN$ such that
\begin{align*}
...
\noindent\begin{minipage}{.5\linewidth}
  ...
  \begin{minipage}{.5\linewidth}
  \[\begin{NiceMatrix}
    z                 & \bloch{7-1}{\rppprecfwd[f,g]} & \prPrec[F,G] \big( (n)_1, (n)_2 \big)  \\
    n                 &                               & z                                      \\
    0                 &                               & (n)_2                                  \\
    0                 &                               & s                                      \\
    0                 &                               & (n)_1                                  \\
  ...
  \noindent\begin{minipage}{.5\linewidth}
    ...
    \begin{minipage}{.5\linewidth}
    \[\begin{NiceMatrix}
      z                 & \bloch{3-1}{\rppprec[f,g]} & z + \prPrec[F,G] \big( (n)_1, (n)_2 \big)  \\
      n                 &                            & n                               \\
      \boldsymbol{0}    &                            & \boldsymbol{0}                  \\
    \end{NiceMatrix}\]
    \end{minipage}
