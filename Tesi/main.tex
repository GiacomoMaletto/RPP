...
\[\begin{NiceMatrix}
  ...
  0 &                       & 0           &                      & 0           &                            & 0           \\
\end{NiceMatrix}\]
This is very powerful: we succesfully defined a function which is able to "erase" data from one position by storing it in the preceding one.
But we will talk more about pairings and their uses in the next paragraph; for now, let's focus on the technique we used.
