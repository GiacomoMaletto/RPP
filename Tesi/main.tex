...
After seeing all these changes you might ask yourself - are these still the original $\RPP$s?
...
because in a way, the \textit{essence} of what $\RPP$s are has not been changed.
