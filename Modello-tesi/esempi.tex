...
\lstinputlisting[float, language=Coq,style=Coq-style, firstline=26, lastline=42,caption={Qesto snippet è l'inclusione diretta da riga 26 a riga 42 di \texttt{lighter.v}},label=Thestartingpoint]{../lighter.v}
